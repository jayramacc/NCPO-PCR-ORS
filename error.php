        ...
        <div class="container">
            <div class="row ">
                <div class="col-lg-12 col-md-12"  >
                     <h2><strong>The Page You Are Looking Is Not Here</strong> </h2>
...
From a cheap and chippy chopper on a big black block!
     ...
     <!--./Error Text End -->
    <div id="just-middle-row" class="clr-blue-bk">
        <div class="container">
                <div class="row pad-top-botm">
                <div class="col-lg-12 col-md-12">
                    <h1>  CHECKOUT OUR OTHER RESOURCES  </h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="footser-end">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    2014 All Rights Reserved | by: <a href="http://binarytheme.com" target="_blank" style="color:#fff" > jayr</a>
