...
<body>
                            ...
                            <div class="item active ">
                                <div class="container center">
                                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 slide-custom">
                                        ...
                                        <h5 class="pull-right"> <b>Online registration</b> </h5>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Present the Requirements Needed and payment to recieve the police clearance form</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="footser-end">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    2018 All Rights Reserved | by: <a href="https://github.com/jayramacc/NCPO-PCR-ORS">NCPO-PCR-ORS</a>
                </div>
            </div>
        </div>
    </div>
