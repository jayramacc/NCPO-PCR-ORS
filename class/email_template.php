                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Thank you for registering to our online registration system in NCPO Naga <br> <br> Click the link below to activate your private key! </p>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;"> 
                                        <a href="<?php echo 'http://' .$_SERVER['SERVER_NAME']. '/class/verify.php?pk=' . @$_GET['pk']; ?>" target="_blank" style="display: inline-block; color:
