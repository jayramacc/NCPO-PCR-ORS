...
<body>
	...
	<header id="header">
		<hgroup>
			...
			<h2 class="section_title">Users</h2><div class="btn_view_site"><a href="login.php">Log out </a></div>
		</hgroup>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="admin.php">Website Admin</a> <div class="breadcrumb_divider"></div> <a class="current">Add New Applicant</a></article>
		</div>
